...
#define MFP2_2_0_F(x) (x<<0)
#define PDRV1_11_10_F(x) (x<<10)

static const struct device_mfp_config ats3605_mmc0_cfg = {
...
static const struct device_mfp_config ats3605_mmc2_cfg = {
...
static const struct device_mfp_config ats3605_spi0_cfg = {
	.periph_id = PERIPH_ID_SPI0,
	.mfp_cfg = {
		{
			.mfp = 0,
			.reg_cfg = {
				 {MFP_CTL2, MFP2_2_0_F(0x7), MFP2_2_0_F(0x0) },
				 {PAD_DRV1, PDRV1_11_10_F(0x3), PDRV1_11_10_F(0x1)},
			},
		},
	},
};
...
int pin_funcmux_select(int periph_id, int mfp)
{
	...
	for (i = 0; (pdev = ats3605_dev_cfg[i]) != NULL; i++)
